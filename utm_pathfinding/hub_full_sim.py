...
"""
from utm_pathfinding import data_utils, PathFinding,Map
import numpy as np
import math
import random
import os
...
if __name__=='__main__':
    ...
    n_hub_uavs = 50 #number of uavs per hub

    #hub coordinates
    #lets say hub is 80m x 80 x 20m -> convert this 
    hub_x_size_meter = 1000
    hub_y_size_meter = 1000
    hub_z_size_meter = 80
    ...
    min_lateral_distance = max_lateral_distance/4
    reserved_table = set()
    excluded_set = set()

    begin_list, end_list = gen_random_coords(int(radius), 
                                hub_x, hub_y, hub_z, 
                                n_hub_uavs, reserved_table, 
